  ...
  return (
    <div className=' flex flex-1 items-center flex-col w-full p-0 h-full'>
      <div className='font-bold text-3xl sm:text-4xl p-4 mt-14 sm:mb-4'>
        <h1>Login</h1>
        <h3 className='text-sm sm:text-lg font-light mt-2 '>{"Dont have an account?  "}<a href="/signup" className='hover:text-blue-500 underline font-medium'>Signup</a></h3>
      </div>
      <div>
        <form className=" mx-auto border-2 p-6 sm:p-10 border-gray-300 rounded-2xl flex flex-col gap-6 font-semibold text-2xl sm:text-3xl w-[250px] h-[320px] sm:h-[380px] sm:w-[480px]">
